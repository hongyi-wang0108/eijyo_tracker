...
### Added
- 数据 Tab：官方处理期间英雄卡 + 8 柱处理参考趋势图（官方区间高亮，无虚构数字）+ 地区信息卡 + 申请路径说明卡 + 两张来源卡；连接真实 ProfileRepository
- 材料 Tab：材料清单（按分类分组）+ 内联状态更新区（2×2 状态格 + 确认）+ 四档筛选 chips + 进度卡实时刷新；连接真实 DocumentRepository
